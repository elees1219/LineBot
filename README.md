...
| `D` | 刪除回覆組 | 0 | `JC  D  水母`<br>`JC  D  ID  110` | | [連結](#d) |
| `Q` | 查詢回覆組 | 0 | `JC  Q  水母`<br>`JC  Q  11  25` | 最多一次15組 | [連結](#q) |
| `I` | 查詢回覆組的詳細資訊 | 0 | `JC  I  水母`<br>`JC  I  ID  10` | 超過3組時會縮短 | [連結](#i) |
...
| `G` | 群組靜音狀態查詢 | 0 | (尚未完成) | | [連結](#g)
| `GA` | 群組靜音管理 | 1+ | (尚未完成) | | [連結](#ga)
...
```
 - **abc**為參數1，代表權限密鑰(需向管理員拿取)
 - `N`為參數2，固定字
 - **Cfffff**為參數3(群組ID)，長度固定33字元
 - **Ufffff**為參數4(使用者ID)，長度固定33字元
 - **abcdefg**為參數5(自訂密鑰)
