...
| `D` | 刪除回覆組 | 0 | 關鍵字 | | `JC  D  水母` | | [連結](#d) |
| `Q` | 指定ID範圍的回覆組 | 0 | 起始ID | 終止ID | `JC  Q  11  25` | 一次最多呼叫15組關鍵字 | [連結](#q) |
| `Q` | 含有指定字的回覆組 | 0 | 部分關鍵字 | | `JC  D  水` | | [連結](#q) |
| `I` | 指定的回覆組詳細資訊 | 0 | 關鍵字 | | `JC  I  水母` | | [連結](#i) |
| `I` | 指定ID的回覆組詳細資訊 | 0 | ID | ID | `JC  I  199  199` | | [連結](#i) |
| `K` | 關鍵字排行榜 | 0 | 名次 | | `JC  K  10` | | [連結](#k) |
| `P` | 特殊小水母相關紀錄 | 0 | | | `JC  P` | | [連結](#p) |
| `H` | 獲取ID | 0 | | | `JC  H` | | [連結](#h) |
| `SHA` | 獲取SHA224加密字串 | 0 | | | `JC  SHA  水母` | | [連結](#sha) |
| `S` | 直接指令 | 3 | 指令 | 密鑰 | `JC  S  __  __` | | [連結](#s) |
| `R` | 刪除高級回覆組 | 3 | 關鍵字 | 密鑰 | `JC  R  水母  __` | | [連結](#r) |
| `M` | 新增高級回覆組 | 3 | 關鍵字 | 回覆 | `JC  M  水母  大水母  __` | 參數3為密鑰 | [連結](#m) |
