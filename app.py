...
def handle_text_message(event):
    ...
    try:
        ...
        print text.startswith('HELP')
        print text.startswith('JC') or text.startswith('HELP') or text.startswith('G')
        print (' ' or '  ') in text
        print text.startswith('JC') or text.startswith('HELP') or text.startswith('G') and ((' ' or '  ') in text)
